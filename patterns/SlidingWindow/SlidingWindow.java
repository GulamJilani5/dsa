...
public class SlidingWindow {
    ...
    public void lengthOfLongestSubstringSlidingWindow() {
        String str = "jilani";
        int result = slidingWindowMaxSum.lengthOfLongestSubstringSlidingWindow_method1(str);
    ...
    public void lengthOfLongestSubstringSlidingWindowFrequencyArray() {
        ...
        int result = slidingWindowMaxSum.lengthOfLongestSubstringSlidingWindow_method2(str);
